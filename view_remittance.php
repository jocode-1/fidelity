...
<head>
  ...
  <title>FS View Remittance</title>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View Remittance</h5>
              ...
              <table class="stripe" style="width:100%" id="example">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Remittance Title </th>
                    <th scope="col">Amount Deposited</th>
                    <th scope="col">Bank Deposited To</th>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="remittance_id"></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                  <p id="remittance_title"></p>
                  <p id="amount_deposited"></p>
                  <p id="bank_deposited"></p>
                  <p id="teller_id"></p>
                  <p id="date"></p>
              </div>
              <!-- <div id="map"></div> -->
        ...
        <div class="modal fade" id="disablebackdrop2" tabindex="-1" data-bs-backdrop="false">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="product_id"></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="row mb-3">
...
<!-- End General Form Elements -->
  ...
  <script src="assets/js/remittance_user.js"></script>
