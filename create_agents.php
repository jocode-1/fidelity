    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Create Agents</h5>
              ...
              <div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="phone" id="phone" name="address" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Assign Sales Point</label>
                  <div class="col-sm-10">
                    <select id="sales_point" name="sales_point" class="form-select"></select>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <button type="submit" id="create_agent" class="btn btn-primary">Create</button>
                  </div>
                </div>
