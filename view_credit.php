...
<head>
  ...
  <title>FS View Credit Records</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Credit Records</li>
          <li class="breadcrumb-item active">View Credit Records</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">View Credit Records</h5>
...
<!-- End General Form Elements -->
  ...
  <script src="assets/js/view_credit_admin.js"></script>
