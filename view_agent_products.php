            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="sales_point_update" name="sales_point">
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
...
<!-- End General Form Elements -->
  ...
  <script src="assets/js/agents_product.js"></script>
